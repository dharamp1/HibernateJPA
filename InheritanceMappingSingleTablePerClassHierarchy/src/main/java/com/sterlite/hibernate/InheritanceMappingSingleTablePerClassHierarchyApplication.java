...
public class InheritanceMappingSingleTablePerClassHierarchyApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(InheritanceMappingSingleTablePerClassHierarchyApplication.class, args);
	}
