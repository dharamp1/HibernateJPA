...
public class InheritanceMappingTablePerConcreteClassApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(InheritanceMappingTablePerConcreteClassApplication.class, args);
	}
